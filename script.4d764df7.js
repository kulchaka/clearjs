...
})(
  {
              ...
              f(c, [
                {
                  ...
                  value: function () {
                    ...
                    return (0, t.row)(
                      (0, t.col)(
                        "<".concat(n, ">").concat(this.value, "</$tag>")
                      ),
                      (0, t.css)(r)
                    );
                  },
            ...
            f(c, [
              {
                ...
                value: function () {
                  ...
                  return (0, t.row)(
                    '<img src="'
                      .concat(this.value, '" style="')
                      .concat((0, t.css)(o), '" alt="')
                      .concat(r, '">'),
                    (0, t.css)(c)
                  );
                },
    ...
    kRZE: [
      function (require, module, exports) {
        ...
        var i = [
          new t.TitleBlock("Contructor on Vanilla JS", {
            tag: "h2",
            styles: {
                ...
                value: function (e) {
                  ...
                  e.forEach(function (e) {
                    console.log(e.toHTML()),
                      t.el.insertAdjacentHTML("beforeend", e.toHTML());
                  });
                },
              },
            ]),
